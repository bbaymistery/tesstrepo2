                ...
                <div className={`${styles.hero_section_container} page_section_container`}>
                    <div className={styles.points_content}>
                        <div className={styles.main_search}>
                            <div className={`${!islinknamecomponent ? 's' : styles.title_div}`}>
                                <h1 className={`${styles.title} ${direction} `}>
                            ...
                            {reservations.map((obj, index) => {
                                ...
                                return (
                                    <div key={index}>
                                        {width < 990 ? <OutsideClickAlert onOutsideClick={(e) => outsideClick({ destination: "pickup", index })}>
                                            <div id={`content${index}pickup`} className={`${styles["input_div_pop_up"]} ${styles['search-input-container']}`} f={String(internalState[`pickup-search-focus-${index}`])} >
                                                ...
                                                {!Array.isArray(internalState[`collecting-pickup-points-${index}`]) ?
                                                    ...
                                                    <HandleSearchResults env={env} language={language} index={index} destination="pickup" setInternalState={setInternalState} collectingPoints={internalState[`collecting-pickup-points-${index}`]} /> : <React.Fragment></React.Fragment>}

                                            </div>
                                        </OutsideClickAlert> : <></>}


                                        {/*  //!Popuop for drop off points */}
                                        {width < 990 ? <OutsideClickAlert onOutsideClick={(e) => outsideClick({ destination: "dropoff", index })}>
                                            <div id={`content${index}dropoff`} d={`content${index}`} className={`${styles["input_div_pop_up"]} ${styles['search-input-container']}`} f={String(internalState[`dropoff-search-focus-${index}`])} >
                                                ...
                                                {!Array.isArray(internalState[`collecting-dropoff-points-${index}`]) ?
                                                    <HandleSearchResults env={env} language={language} index={index} destination="dropoff" setInternalState={setInternalState} collectingPoints={internalState[`collecting-dropoff-points-${index}`]} /> : <React.Fragment></React.Fragment>}
                                            </div>
                                        </OutsideClickAlert> : <></>}
                                        ...
                                        <div className={`${styles.points} ${direction}`} direction={String(direction === "rtl")}>
                                            <div className={`${styles.search_menu} ${styles.first_column}`}>
                                                ...
                                                {/* selectedPoints */}
                                                {selectedPickupPoints.length > 0 ? <SelectedPointsOnHomePage env={env} index={index} destination="pickup" points={selectedPickupPoints} language={language} /> : <React.Fragment></React.Fragment>}
                                            ...
                                            <div className={`${styles.search_menu} ${styles.second_column}`}>
                                                ...
                                                {/* selectedPoints */}
                                                {selectedDropoffPoints.length > 0 ? <SelectedPointsOnHomePage env={env} index={index} destination="dropoff" points={selectedDropoffPoints} language={language} /> : <React.Fragment></React.Fragment>}
                                                {/* add extra pooint div */}
                    ...
                    <div className={styles.advertisiment_images}>
                        <a rel="noreferrer" href="https://www.tripadvisor.co.uk/Attraction_Review-g186338-d11966434-Reviews-Airport_Pickups_London-London_England.html" target={"_blank"} >
                            <div className={`${styles.review_trip_advisor} ${width < 768 ? "" : "bottom_to_top_animation2"}`} style={{ animationDelay: '.5s', animationDuration: '1s' }}>
                                <Image loading={"eager"} fill priority style={{ objectFit: 'contain' }} sizes="(max-width: 768px) 100vw, 50vw" src="/images/others/advisorTrip.webp" alt="Airport Pickups London Tripadvisor" />
                            </div>
                        </a>
                        ...
                        <a rel="noreferrer" href="https://www.trustpilot.com/review/airport-pickups-london.com" target={"_blank"} >
                            <div className={`${styles.review_trip_advisor} ${width < 768 ? "" : "bottom_to_top_animation2"}`} style={{ animationDelay: '0.75s', animationDuration: '1s' }}>
                                <Image loading={"eager"} fill priority style={{ objectFit: 'contain' }} sizes="(max-width: 768px) 100vw, 50vw" src="/images/others/Excellent.webp" alt=" Airport Pickups London Trustpilot " />
                            </div>
                        </a>
                        ...
                        <a rel="noreferrer" href="https://www.reviews.co.uk/company-reviews/store/airport-pickups-london-com" target={"_blank"} >
                            <div className={`${styles.review_trip_advisor} ${width < 768 ? "" : "bottom_to_top_animation2"}`} style={{ animationDelay: '1s', animationDuration: '1s' }}>
                                <Image loading={"eager"} fill priority style={{ objectFit: 'contain' }} sizes="(max-width: 768px) 100vw, 50vw" src="/images/others/Reviews.webp" alt="Airport Pickups London Review" />
                            </div>
                        </a>
                    </div>
                </div>
