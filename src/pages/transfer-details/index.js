                                    ...
                                    reservations.map((obj, index) => {
                                        ...
                                        return (
                                            <div className={`${styles.taxideals_subcontainer_content} ${direction}`} key={index}>
                                                ...
                                                {<TransferJourneySummaryPanel language={language} isTaxiDeal={true} index={index} splitedHour={splitedHour} splitedMinute={splitedMinute} splitedDate={splitedDate} quotation={quotation} selectedDropoffPoints={selectedDropoffPoints} selectedPickupPoints={selectedPickupPoints} />}
                                            </div>
                                        )
                                    })
                                    : <></>}
                                    ...
                                    return (
                                        <div key={index} >
                                            <div className={`${styles.transferdetails_subcontainer_content} ${direction}`}>
                                                ...
                                                {quotations[0].taxiDeal ? <></> : <TransferJourneySummaryPanel language={language} journeyType={journeyType} index={index} splitedHour={splitedHour} splitedMinute={splitedMinute} splitedDate={splitedDate} quotation={quotation} selectedDropoffPoints={selectedDropoffPoints} selectedPickupPoints={selectedPickupPoints} />}
                                            </div>
                                            {index === 1 || (index === 0 && +journeyType === 0) ?
