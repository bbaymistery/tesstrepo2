...
import logoImage1 from '../../../public/logos/noBgLogo.png'  //../../../../public/logos/noBgLogo.png
...
const Login = () => {
    ...
    const handleSend = () => {
        ...
        if (!handleInputs.pass || !handleInputs.email || !handleInputs.email.includes("@")) {
            ...
            dispatch(login(handleInputs.email, handleInputs.pass, router, recaptchaToken = true, setAlert));
